...
import de.gabriel.listrandomizer.data.ItemDao
import de.gabriel.listrandomizer.data.ItemEntry
import de.gabriel.listrandomizer.data.ListRandomizerDatabase
...
class ItemDaoTest {
    ...
    private lateinit var randomizerDatabase: ListRandomizerDatabase
    ...
    fun createDb() {
        ...
        // process is killed.
        randomizerDatabase = Room.inMemoryDatabaseBuilder(context, ListRandomizerDatabase::class.java)
            // Allowing main thread queries, just for testing.
            .allowMainThreadQueries()
            .build()
        itemDao = randomizerDatabase.itemDao()
    }

    @After
    @Throws(IOException::class)
    fun closeDb() {
        randomizerDatabase.close()
    }
